      ...
      <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        >
          ...
          {todayAppointments.length === 0 ? (
            ...
            todayAppointments.map(apt => (
              <Pressable
                ...
                onPress={() =>
                  router.push(
                    `/doctor/patient-medical-history?patientId=${apt.patientId}&patientName=${encodeURIComponent(
                      apt.patientName
                    )}`
                  )
                }
              >
                ...
                <Text style={styles.tapHint}>
                  Tap to view patient medical history
                </Text>
              </Pressable>
            ))
          )}
          ...
          <View style={styles.quickActions}>
            ...
            <Pressable
              style={styles.actionButton}
              onPress={() => router.push('/doctor/medical-prescription')}
            >
...
const styles = StyleSheet.create({
  ...
  welcomeText: { fontSize: 14, color: Colors.white, opacity: 0.9 },
  userName: { fontSize: 20, fontWeight: '700', color: Colors.white },
  userSpecialty: { fontSize: 12, color: Colors.white, opacity: 0.8 },
  logoutButton: {
    width: 44,
    height: 44,
    borderRadius: 22,
  ...
  tapHint: { fontSize: 12, color: Colors.secondary, fontWeight: '500' },
  content: { flex: 1 },
  ...
  timeText: { fontSize: 14, fontWeight: '600', color: Colors.text.secondary },
  statusBadge: {
  ...
  emergencyText: { color: Colors.status.error },
  patientName: { fontSize: 16, fontWeight: '600', color: Colors.text.primary },
  specialty: { fontSize: 13, color: Colors.text.secondary },
